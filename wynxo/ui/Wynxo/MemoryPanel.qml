...
/*!
    What Wynxo remembers between tasks — the real memory.md, edited in place.
...
Item {
    ...
    ColumnLayout {
        ...
        PanelHeader {
            ...
            IconButton {
                width: 28; height: 28; iconSize: 12
                iconName: "launch"
                tooltip: "Open memory.md outside Wynxo"
        ...
        EmptyState {
            ...
            detail: "Tell Wynxo something worth keeping — “I deploy with Nix, never Docker” — and it carries into every later task, in Wynxo and Wynxi alike."
        }
    ...
    ConfirmSheet {
        ...
        message: "Every note Wynxo has saved is removed. Tasks already in your history are not touched."
