...
model appending a note while the user has the file open in Wynxo's editor can
...
TITLE = "# Wynxo memory"
INTRO = ("Notes Wynxo keeps between tasks. Edit or delete anything here; it is "
...
class Memory:
    ...
    def write(self, text: str) -> None:
        """Replace the whole file — what Wynxo's own memory editor saves."""
        with self._lock:
